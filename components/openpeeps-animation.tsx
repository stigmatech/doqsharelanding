...
const OpenPeepsHero = () => {
  return (
    <div className="relative h-full w-full bg-linear-to-b from-blue-50 to-white text-black">
      <div className="top-22 absolute left-1/2 grid -translate-x-1/2 content-start justify-items-center gap-4 text-center text-black">
        <span className="relative max-w-[12ch] text-sm md:text-base font-semibold uppercase leading-tight opacity-70 after:absolute after:left-1/2 after:top-full after:h-8 after:w-px after:bg-linear-to-b after:from-white after:to-black after:content-['']">
          DoQshare Community
        </span>
      </div>
