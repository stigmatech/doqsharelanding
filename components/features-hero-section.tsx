                ...
                <div className="py-12 md:pb-8 lg:pb-12 lg:pt-16">
                    <div className="relative mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                        <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                            <h1 className="mt-4 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-8 xl:text-7xl">Powerful Features for Secure Document Sharing</h1>
                            <p className="mt-8 max-w-2xl text-balance text-lg">Everything you need to share, track, and protect your most important documents with enterprise-grade security and advanced analytics.</p>
